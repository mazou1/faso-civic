<template>
  ...
  <p class="sous-titre">
    ...
    ceux que vous croisez partout sur FasoCivic.
  </p>
...
const SECTIONS = [
  ...
  },
  {
    ...
    termes: [
      ...
      { terme: "Compte rendu (CR)", definition: "Le document officiel publié après chaque Conseil, qui relate les délibérations, communications et nominations. La matière première de FasoCivic." },
      { terme: "Engagement financier", definition: "Sur FasoCivic : toute dépense chiffrée décidée en Conseil des ministres — marché public, convention, prêt, subvention ou garantie." },
      ...
      { terme: "Matricule (Mle)", definition: "L'identifiant unique d'un agent de la fonction publique (ex. « Mle 39 652 W »). FasoCivic l'utilise pour distinguer les homonymes dans l'annuaire." },
      { terme: "Mandat", definition: "Sur FasoCivic : la période pendant laquelle une personne occupe un poste, reconstituée entre sa nomination et son éventuelle fin de fonction." },
    ],
  },
  {
    ...
    termes: [
      ...
      { terme: "Légiburkina", definition: "La base de données juridique officielle du Secrétariat général du Gouvernement — la source des 4 900 textes de FasoCivic." },
